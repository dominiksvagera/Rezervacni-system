        ...
        <div class="max-w-5xl mx-auto">
            <div class="flex flex-col items-center md:flex-row">
                ...
                <div class="w-full space-y-5 md:w-3/5 md:pr-16">
                    <p class="font-medium text-blue-500 uppercase" data-primary="blue-500">Kontaktujte nás</p>
                    <h2 class="text-2xl font-extrabold leading-none text-black sm:text-3xl md:text-5xl">
                        Zanechte nám na sebe kontakt a nebo nám rovnou napište zprávu či zavolejte. 
                    </h2>
                    <h2 class="text-lg font-medium leading-none text-black sm:text-xl md:text-lg">
                        dominik.svagera@gmail.com / +420 739 575 863
                    </h2>
                    <h2 class="text-lg font-medium leading-none text-black sm:text-xl md:text-lg">
                ...
                <div class="w-full mt-16 md:mt-0 md:w-2/5">
                    <div class="relative z-10 h-auto p-8 py-10 overflow-hidden bg-white border-b-2 border-gray-300 rounded-lg shadow-2xl px-7" data-rounded="rounded-lg" data-rounded-max="rounded-full">
                        <h3 class="mb-6 text-2xl font-medium text-center">Kontaktní údaje</h3>
                        ...
                        <input type="text" name="number" id="number" class="block w-full px-4 py-3 mb-4 border border-2 border-transparent border-gray-200 rounded-lg focus:ring focus:ring-blue-500 focus:outline-none" data-rounded="rounded-lg" data-primary="blue-500" placeholder="Telefonní číslo">
                        <input type="text" name="text" id="text" class="block w-full px-4 py-3 mb-4 border border-2 border-transparent border-gray-200 rounded-lg focus:ring focus:ring-blue-500 focus:outline-none" data-rounded="rounded-lg" data-primary="blue-500" placeholder="Text">
                        <div class="block">
                            <button class="w-full px-3 py-4 font-medium text-white bg-indigo-600 rounded-lg" data-primary="blue-600" data-rounded="rounded-lg">Odeslat</button>
                        </div>
                    </div>
                </div>
