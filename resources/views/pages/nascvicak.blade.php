...
<section class="relative w-full px-8 text-white bg-gray-300 body-font" data-tails-scripts="//unpkg.com/alpinejs" {!! $attributes ?? '' !!}>
        ...
        <section>
            <ul>
                <h2 class="flex items-center justify-between m-4 text-xl font-semibold leading-tight border-0 border-gray-300 lg:text-3xl md:text-2xl">
                    Náš cvičák
                </h2>
                
                <p class="flex items-center justify-between text-lg  bg-indigo-300 hover:bg-indigo-600 w-72 h-full rounded-3xl bg-center text-center p-4 m-2">Zde je přehled našich disciplín.</p>
            </ul>
        </section>
